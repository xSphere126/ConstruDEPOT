...
export const grupos: { nombre: string; marcas: Marca[] }[] = [
  ...
  },
  {
    ...
    marcas: [
      ...
      { nombre: 'SAS Prefabricados de Hormigón', url: 'https://sas1900.com/', logo: '/brands/sas1900.webp' },
      { nombre: 'Verniprens', url: 'https://verniprens.com/', logo: '/brands/verniprens.png' },
